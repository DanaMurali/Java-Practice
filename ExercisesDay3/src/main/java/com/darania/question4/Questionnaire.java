...
// Three questions were stored in string variables
        ...
        String question1 = "What is the moon made up of?" + "(a)All the cheese you can eat!\n(b)Loads of rocks and metals\n(c)It's just a big light bulb...";

        String question2 = "Who is the unabomber?" + "(a)Ted Kaczynski\n(b)Pablo Escobar\n(c)Al Capone";

        String question3 = "Where did Bilbo Baggins go on his adventure?" + "(a)He teleported to another dimension.\n(b)He went to a mean girls themed spa holiday!\n(c)He journeyed to the Lonely Mountain to battle a dragon.";
